...
namespace AdventOfCode2018.Day01
{
    public class Day01
    {
        ...
        public static void Puzzle1()
        {
             ...
             * time; the device will indicate fixed anomalies with stars. The other 
             * bad news is that we only have one device and you're the best person for 
             * the job! Good lu--" She taps a button on the device and you suddenly feel 
             * like you're falling. To save Christmas, you need to get all fifty stars 
             * by December 25th.
             * 
